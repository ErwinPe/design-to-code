    ...
    >
        ...
        <div class="flex flex-col justify-between min-h-[332px]">
            <div>
                ...
                <p
                    class="text-[#020712CC] text-[32px] font-[700] leading-[32px] mt-3"
                >
            ...
            <div class="flex gap-3">
                ...
                >
                    ...
                    >
                        <p
                            class="group-hover:-translate-x-5 ease duration-300 transform"
                        >
                            Ajouter au panier
                        </p>
                        <ShoppingCartIcon
                    ...
                    <div
                        v-else
                        class="grow flex justify-between items-center py-2 px-8 select-none"
                    >
                        <div @click="quantity--">
                            <TrashIcon
