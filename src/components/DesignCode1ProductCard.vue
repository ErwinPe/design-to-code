<template>
    <div
        ...
        <div class="flex flex-col justify-between min-h-[332px]">
            ...
            <div>
                <p class="text-[#02071266] text-[16px] line-through">
                    183.99 €
                </p>
            ...
            <div class="flex gap-3">
                <!-- Add to cart button -->
                <div class="text-white text-[16px] font-[600] rounded-xl grow flex bg-[#477AEB] overflow-hidden">
                    <!-- Initial state -->
                    ...
                    <!-- Has quantity state -->
                    <div v-else class="grow flex justify-between items-center py-2 px-8 select-none">
                        <div @click="quantity--">
                            <TrashIcon class="size-5 cursor-pointer stroke-2" v-if="quantity === 1" />
